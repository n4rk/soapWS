 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://bankWS/", wsdlLocation = "http://localhost:9191/?wsdl")
public class BankWS
    extends Service
{
    ...
    private final static QName BANKWS_QNAME = new QName("http://bankWS/", "BankWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://bankWS/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bankWS/", "BanqueServicePort"), BanqueService.class, features);
    }
